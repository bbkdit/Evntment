...
<section class="bg-white pad-75">
  <div class="container">
    <h1 class="section-title"> Birthday Decoration </h1>
    <div class="col-md-4">
      <div class="card">
        <figure> <img src="evmng/birthday-decoration/7500/7500-1.jpg" class="img-responsive"> </figure>
        <div class="card-details">
          <h6> Bangalore</h6>
          <h4> <a href="birthday-decoration/7500/"> Birthday party decoration </a></h4>
          <div class="price col-md-6 no-padding">
            <span class="rupee"> Rs </span> <span class="num">7500 </span>
          </div>
          <div class="button-view col-md-6 text-right no-padding">
            <a href="birthday-decoration/7500/" class="btn-view-more"> View More </a>
          </div>
    ...
    <div class="col-md-4">
      <div class="card">
        ...
        <div class="card-details">
          <h6>Bangalore</h6>
          <h4><a href="experience/cessena/"> Cessena </a></h4>
          <div class="price col-md-6 no-padding">
            <span class="rupee"> Rs </span> <span class="num">4000 </span><span class="per-head"> Per Head </span>
          </div>
          <div class="button-view col-md-6 text-right no-padding">
            <a href="experience/cessena/" class="btn-view-more"> View More </a>
          </div>
          <div class="clearfix"></div>
        </div>
      </div>
